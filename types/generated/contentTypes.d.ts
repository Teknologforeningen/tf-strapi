...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    donation_page: Schema.Attribute.Component<'donation.page', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiContentSectionContentSection
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    file_folders: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiFileFolderFileFolder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    content_section: Schema.Attribute.Relation<
      'manyToOne',
      'api::content-section.content-section'
    >;
    createdAt: Schema.Attribute.DateTime;
    ...
    folderId: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    banner: Schema.Attribute.Component<'page.banner', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiNavbarNavbar extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    links: Schema.Attribute.DynamicZone<
    ...
    > &
      Schema.Attribute.Private;
    private_pages: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiPrivateFolderPrivateFolder
  extends Struct.CollectionTypeSchema {
...
export interface ApiPrivatePagePrivatePage extends Struct.CollectionTypeSchema {
...
export interface ApiPrivateSectionPrivateSection
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    private_page: Schema.Attribute.Relation<
      'manyToOne',
      'api::private-page.private-page'
    >;
    publishedAt: Schema.Attribute.DateTime;
